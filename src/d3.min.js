!function () {
  ...
  function Y() {
    var n = ".dragsuppress-" + ++Pa, t = "click" + n,
  ...
  function Pt(n) {
    ...
    return function (n) {
      var r = hc.exec(n), e = r[1] || " ", o = r[2] || ">", a = r[3] || "", c = r[4] || "", l = r[5], s = +r[6],
  ...
  function gr() {
    function n(n, t) {
      n *= Ia, t = t * Ia / 2 + Ua / 4;
      var r = n - e, o = r >= 0 ? 1 : -1, a = o * r, c = Math.cos(t), l = Math.sin(t), s = i * l,
  ...
  function Er() {
    function n(n, u) {
      n *= Ia;
      var i = Math.cos(u *= Ia), o = i * Math.cos(n), a = i * Math.sin(n), c = Math.sin(u),
  ...
  function Ar() {
    function n(n, t) {
      n *= Ia;
      var r = Math.cos(t *= Ia), o = r * Math.cos(n), a = r * Math.sin(n), c = Math.sin(t), l = u * c - i * a,
        s = i * o - e * c, f = e * a - u * o, h = Math.sqrt(l * l + s * s + f * f), g = e * o + u * a + i * c,
  ...
  function zr(n, t, r, e, u) {
    return function (i, o) {
      ...
      var p, v, d, m = t(o), y = i.invert(e[0], e[1]), x = {
        point: a, lineStart: l, lineEnd: s, polygonStart: function () {
  ...
  function Ur(n, t) {
    ...
    for (var a = 0, c = t.length; c > a; ++a) {
      ...
      if (s) for (var f = l[0], h = f[0], g = f[1] / 2 + Ua / 4, p = Math.sin(g), v = Math.cos(g), d = 1; ;) {
        d === s && (d = 0), n = l[d];
        var m = n[0], y = n[1] / 2 + Ua / 4, x = Math.sin(y), M = Math.cos(y), _ = m - h, b = _ >= 0 ? 1 : -1,
          w = b * _, S = w > Ua, k = p * x;
  ...
  function le(n) {
    ...
    function u(t, r, e, a, c, l, s, f, h, g, p, v, d, m) {
      ...
      if (M > 4 * i && d--) {
        var _ = a + g, b = c + p, w = l + v, S = Math.sqrt(_ * _ + b * b + w * w), k = Math.asin(w /= S),
          E = Ma(Ma(w) - 1) < Fa || Ma(e - h) < Fa ? (e + h) / 2 : Math.atan2(b, _), N = n(E, k), A = N[0], C = N[1],
          L = A - t, q = C - r, T = x * L - y * q;
  ...
  function Ae(n, t, r, e) {
    var u = Math.cos(t), i = Math.sin(t), o = Math.cos(e), a = Math.sin(e), c = u * Math.cos(n), l = u * Math.sin(n),
      s = o * Math.cos(r), f = o * Math.sin(r), h = 2 * Math.asin(Math.sqrt(tt(e - t) + u * o * tt(r - n))),
  ...
  function Oe(n, t, r, e) {
    var u = n[0], i = r[0], o = t[0] - u, a = e[0] - i, c = n[1], l = r[1], s = t[1] - c, f = e[1] - l,
  ...
  function Xe(n) {
    ...
    if (al.insert(t, c), t || r) {
      ...
      tu(t), tu(r);
      var l = t.site, s = l.x, f = l.y, h = n.x - s, g = n.y - f, p = r.site, v = p.x - s, d = p.y - f,
  ...
  function nu(n) {
    ...
    if (t && r) {
      ...
      if (e !== i) {
        ...
        if (!(h >= -Oa)) {
          var g = c * c + l * l, p = s * s + f * f, v = (f * g - l * p) / h, d = (c * p - s * g) / h, f = d + a,
            m = fl.pop() || new Qe;
  ...
  function eu(n, t) {
    var r = n.b;
    if (r) return !0;
    var e, u, i = n.a, o = t[0][0], a = t[1][0], c = t[0][1], l = t[1][1], s = n.l, f = n.r, h = s.x, g = s.y, p = f.x,
      v = f.y, d = (h + p) / 2, m = (g + v) / 2;
    if (v === g) {
      if (o > d || d >= a) return;
      if (h > p) {
        if (i) {
  ...
  function Bu(n, t) {
    var r, e = [], u = [], i = oa.transform(n), o = oa.transform(t), a = i.translate, c = o.translate, l = i.rotate,
  ...
  try {
    ...
    var pa = fa.Element.prototype, va = pa.setAttribute, da = pa.setAttributeNS, ma = fa.CSSStyleDeclaration.prototype,
      ya = ma.setProperty;
  ...
  oa.mouse = function (n) {
    ...
    function t(n, t, u, i, o) {
      return function () {
        ...
        var l, s = this, f = oa.event.target, h = s.parentNode, g = r.of(s, arguments), p = 0, v = n(),
          d = ".drag" + (null == v ? "" : "-" + v), m = oa.select(u()).on(i + d, a).on(o + d, c), y = Y(), x = t(h, v);
        e ? (l = e.apply(s, arguments), l = [l.x - x[0], l.y - x[1]]) : l = [0, 0], g({type: "dragstart"})
      }
    }

    var r = M(n, "drag", "dragstart", "dragend"), e = null, u = t(v, oa.mouse, X, "mousemove", "mouseup"),
      i = t(V, oa.touch, $, "touchmove", "touchend");
    return n.origin = function (t) {
      return arguments.length ? (e = t, n) : e
    }, oa.rebind(n, r, "on")
  };
  var Ua = Math.PI, ja = 2 * Ua, Ha = Ua / 2, Fa = 1e-6, Oa = Fa * Fa, Ia = Ua / 180, Ya = 180 / Ua, Za = Math.SQRT2,
    Va = 2, $a = 4;
  oa.interpolateZoom = function (n, t) {
    ...
    var e = n[0], u = n[1], i = n[2], o = t[0], a = t[1], c = t[2], l = o - e, s = a - u, f = l * l + s * s,
      h = Math.sqrt(f), g = (c * c - i * i + $a * f) / (2 * i * Va * h),
      p = (c * c - i * i - $a * f) / (2 * c * Va * h), v = Math.log(Math.sqrt(g * g + 1) - g),
    ...
    function l() {
      ...
      var e = this, i = oa.event.target, l = q.of(e, arguments), s = 0, f = oa.select(fa).on(A, n).on(C, r),
        g = t(oa.mouse(e)), p = Y();
      H.call(e), o(l)
    }
    ...
    function s() {
      ...
      var h, g = this, p = q.of(g, arguments), v = {}, d = 0, x = ".zoom-" + oa.event.changedTouches[0].identifier,
        M = "touchmove" + x, _ = "touchend" + x, b = oa.select(oa.event.target).on(M, i).on(_, f),
        w = oa.select(g).on(N, null).on(L, r), k = Y();
      H.call(g), r(), o(p)
    }
    ...
    var p, v, d, m, x, _, b, w, S = {x: 0, y: 0, k: 1}, k = [960, 500], E = Ba, N = "mousedown.zoom",
      A = "mousemove.zoom", C = "mouseup.zoom", L = "touchstart.zoom", q = M(n, "zoomstart", "zoom", "zoomend");
  ...
  var Nc, Ac, Cc, Lc, qc, Tc, zc, Rc, Dc, Pc, Uc, jc = {
    sphere: v, point: Sr, lineStart: Er, lineEnd: Nr, polygonStart: function () {
      jc.lineStart = Ar
    }, polygonEnd: function () {
      jc.lineStart = Er
    }
  ...
  oa.geo.clipExtent = function () {
    ...
    var r, e = (t[0] - n[0]) * Ia, u = n[1] * Ia, i = t[1] * Ia, o = Math.sin(e), a = Math.cos(e), c = Math.sin(u),
  ...
  (oa.geo.conicEqualArea = function () {
    ...
    var t, r, e, u, i = oa.geo.albers(),
      ...
      a = oa.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), c = {
        point: function (n, r) {
          t = [n, r]
        }
      };
  ...
  var Ic, Yc, Zc, Vc, $c, Xc, Bc = {
    ...
    point: ue, lineStart: ie, lineEnd: oe, polygonStart: function () {
      Wc.lineStart = ae
    }, polygonEnd: function () {
  ...
  var Gc, Kc = {sphere: v, point: v, lineStart: Ce, lineEnd: v, polygonStart: v, polygonEnd: v}, Qc = Le(function (n) {
  ...
  oa.interpolateTransform = Bu, oa.layout = {}, oa.layout.bundle = function () {
    ...
    var r, e, u, i, o, a = {}, c = oa.dispatch("start", "tick", "end"), l = [1, 1], s = .9, f = yl, h = xl, g = -30,
      p = Ml, v = .1, d = .64, m = [], y = [];
  ...
  oa.layout.hierarchy = function () {
    ...
    function n(i) {
      var o = i.map(function (r, e) {
        ...
        c = (("function" == typeof u ? u.apply(this, arguments) : u) - a) / oa.sum(o), l = oa.range(i.length);
  ...
  oa.layout.histogram = function () {
    ...
    function n(n, i) {
      var o = r.call(this, n, i), a = o[0], c = u[0], l = u[1],
    ...
    function t(r) {
      var i = r.children;
      if (i && i.length) {
        var o, a, c, l = f(r), s = [], h = i.slice(), p = 1 / 0,
    ...
    var o, a = oa.layout.hierarchy(), c = Math.round, l = [1, 1], s = null, f = Vi, h = !1, g = "squarify",
      p = .5 * (1 + Math.sqrt(5));
  ...
  oa.scale.quantile = function () {
    ...
    function n() {
      var n = t.apply(this, arguments), i = r.apply(this, arguments), o = e.apply(this, arguments) + Tl,
        a = u.apply(this, arguments) + Tl, c = (o > a && (c = o, o = a, a = c), a - o), l = Ua > c ? "0" : "1",
        s = Math.cos(o), f = Math.sin(o), h = Math.cos(a), g = Math.sin(a);
  ...
  Yl.call = La.call, Yl.empty = La.empty, Yl.node = La.node, Yl.size = La.size, oa.transition = function (n) {
    ...
    function n(n) {
      n.each(function () {
        var n, l = oa.select(this), s = this.__chart__ || r, f = this.__chart__ = r.copy(),
          h = null == c ? f.ticks ? f.ticks.apply(f, a) : f.domain() : c,
          g = null == t ? f.tickFormat ? f.tickFormat.apply(f, a) : Nt : t, p = l.selectAll(".tick").data(h, f),
          v = p.enter().insert("g", ".domain").attr("class", "tick").style("opacity", Fa),
          d = oa.transition(p.exit()).style("opacity", Fa).remove(), m = oa.transition(p.order()).style("opacity", 1),
          y = Bi(f), x = l.selectAll(".domain").data([0]),
  ...
  oa.svg.brush = function () {
    ...
    function u() {
      ...
      var x, M, _ = this, b = oa.select(oa.event.target), w = a.of(_, arguments), S = oa.select(_), k = b.datum(),
        E = !/^(n|s)$/.test(k) && c, N = !/^(e|w)$/.test(k) && l, A = b.classed("extent"), C = Y(), L = oa.mouse(_),
    ...
    var i, o, a = M(n, "brushstart", "brush", "brushend"), c = null, l = null, s = [0, 0], f = [0, 0], h = !0, g = !0,
      p = Bl[0];
    return n.event = function (n) {
      n.each(function () {
  ...
  var Xl = {
      ...
      se: "nwse-resize",
      sw: "nesw-resize"
    }, Bl = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []], Jl = pc.format = Mc.timeFormat,
    Wl = Jl.utc, Gl = Wl("%Y-%m-%dT%H:%M:%S.%LZ");
